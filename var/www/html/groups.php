...
echo "<tr><td style='font-weight:bold; font-size:25px;'>Groups</td></tr>";
$sql = "select * from groups";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
      echo "<tr><td><a href='/group.php?link=".$row["title"]."'><div class='chip'><img src='/images/group-2-512.png' alt='Person' width='96' height='96'>".$row["title"]. "</div></a></td></tr>";
    }
} else {
...
<p>
  <button onclick="window.location.href='/addgroup.php'" class="w3-button w3-white w3-border">Add Group</button>
</p>
</div>
</div>
</body>
