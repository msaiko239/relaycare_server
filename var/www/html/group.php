...
<a class="active" href='/groups.php'>Groups</a>
...
if (answer)
window.location="/deletegrp.php?link=" + obj;
}
</script>
</head>
<body>
...
$sql = "select * from groups where title like '$output';";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
         ...
         echo "<h1><tr class='resident'><td><font size='6'>" .$row["title"]. "</font></td></tr></h1>";
         echo "<tr class='resident'><td><a href='javascript:DelRes(\"".$row["title"]."\");'>Delete Group</a></td></tr>";
         echo "</table>";
    }
} else {
...
echo "<h1><tr class='resident'><td><font size='5'>" ."Members" ."</font></td></tr></h1>";
$sql = "select * from accounts where grp like '$output';";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
         echo "<h1><tr class='resident'><td>" .$row["name"]. "</td></tr></h1>";
    }
} else {
