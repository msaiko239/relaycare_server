...
$sql = "select count(*) total from reports where starttime between '$sttime' and '$etime';";
...
$sql2 = "select avg(timestampdiff(SECOND, starttime, endtime)) as avgdiff from reports where starttime between '$var1' and '$var2'";
echo "<table style='width:65%' align='center'";
...
$sttime = str_replace("T", " ", $var1);
$etime = str_replace("T", " ", $var2);
$sql = "select * from reports where starttime between '$sttime' and '$etime';";
echo "<table style='width:65%' align='center'";
