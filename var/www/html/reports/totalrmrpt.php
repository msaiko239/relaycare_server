...
<form method="post" action="callsperrm.php" align="center">
...
$sql = "SELECT room FROM reports group by room;";

$result = mysqli_query($link,$sql);
if ($result != 0) {
    echo '<div class="col-25"><label>Room</div>';
    echo '<div class="col-75"><select class="col-75" name="room">';
