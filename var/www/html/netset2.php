...
<form action="setnetwork.php" method="post" align="center">
 <table align="center">
<?php
...
?>
  ...
  <tr><td><br></br></td></tr>
  <tr><td>IP Address  </td><td><input type="text" name="ipaddr" id="ipaddr" /><br /></td></tr>
  <tr><td>Subnet Mask </td><td><input type="text" name="sbnmsk" id="sbnmsk" /><br /></td></tr>
  <tr><td>Default Gateway  </td><td><input type="text" name="defgw" id="defgw" /><br /></td></tr>
  <tr><td>DNS Servers </td><td><input type="text" name="dnssrv" id="dnssrv" /><br /></td></tr>
  <tr><td></td></tr>
