...
<h2>Add Resident</h2>
<div class="container">
  <form method="post" action="device_page.php">
  <div class="row">
    <div class="col-25">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="devtype" name="devtype" placeholder="Device Type..">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
      <label for="room">Serial</label>
    </div>
    <div class="col-75">
      <input type="text" id="serial" name="serial" placeholder="Device Serial #..">
    </div>
  </div>
  <div class="row">
