...
if (answer)
window.location="/deleteuser.php?link=" + obj;
}
</script>
</head>
<body>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
         $_SESSION[room] = $row["fname"];
         $_SESSION[bed] = $row["lname"];
         $_SESSION[phone] = $row["extnum"];
         $_SESSION[grp] = $row["grp"];
         echo "<h1><tr class='resident'><td><font size='6'>" .$row["fname"] . "  " . $row["lname"]. "</font></td></tr></h1>";
         echo "<tr class='resident'><td>"."Username: "."". $row["username"]. ""." | Extension: "."" .$row["extnum"]. ""." | Groups: "."" .$row["grp"]. "<a href='javascript:DelRes(\"".$row["username"]."\");'>Delete User</a></td></tr>";
         echo "</table>";
    }
} else {
...
<table align='center'>
<tr><td><p><button onclick="window.location.href='/edituser.php?link=<?php echo htmlspecialchars($output); ?>'" class="w3-button w3-white w3-border">Edit User</button></p></td>
</table>
</div>
</div>
</body>
