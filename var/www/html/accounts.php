...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      echo "<tr><td><a href='/resident.php?link=".$row["name"]."'><div class='chip'><img src='/images/icon.png' alt='Person' width='96' height='96'>".$row["name"]. " - " .$row["room"]."</div></a></td></tr>";
    }
} else {
...
<p>
  <button onclick="window.location.href='/addaccount.php'" class="w3-button w3-white w3-border">Add Resident</button>
</p>
</div>
</div>
</body>
