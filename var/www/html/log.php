...
<div style="width:73%"class="container">
<?php
   echo "<table style='width:25%' align='center'><tr><td style='font-weight:bold; font-size:25px;'>Today's Log</td></tr></table>";
   $output = file_get_contents("/var/log/pyscript.log");
   echo '<pre>'.$output.'</pre>';
?>
</div>
</body>
